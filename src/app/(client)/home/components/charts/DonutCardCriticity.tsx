...
export default class DonutCardCriticity extends PureComponent<Props> {
  render() {
    ...
    const data = conversionIndex
      ? [
          { name: "Crítica", value: conversionIndex.crit },
          { name: "Alta", value: conversionIndex.high },
          { name: "Média", value: conversionIndex.medium },
          { name: "Baixa", value: conversionIndex.low },
          { name: "Info", value: conversionIndex.info },
        ]
      : [];
