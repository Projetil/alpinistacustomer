"use client";
import { IStatusHome } from "@/types/ITab4And5";
...
export default class DonutCardStatus extends PureComponent<Props> {
  render() {
    ...
    const data = conversionIndex
      ? [
          { name: "Pendente", value: conversionIndex.totalPending },
          { name: "Reaberto", value: conversionIndex.totalReopened },
          { name: "Corrigido", value: conversionIndex.totalFixed },
          { name: "Aceito", value: conversionIndex.totalAccepted },
          { name: "Em reteste", value: conversionIndex.totalInRetest },
          { name: "Em tratamento", value: conversionIndex.totalInTreatment },
          { name: "Não existente", value: conversionIndex.totalNonExistent },
          { name: "Não executado", value: conversionIndex.totalNotExecuted },
        ]
      : [];
